 ...
 * Use the {@link CustomerCare#newInstance} factory method to
...
public class CustomerCare extends Fragment {
    ...
    public static CustomerCare newInstance(String param1, String param2) {
        CustomerCare fragment = new CustomerCare();
