            ...
            case RESULT_SELECT_IMAGE:
                ...
                if (resultCode == Activity.RESULT_OK && data != null && data.getData() != null) {
                    try{
                        ...
                        String picturePath = cursor.getString(columnIndex).toString();

                        Log.e(TAG,"Picture before "+picturePath);
                        if(picturePath.contains(" ")){
                            Log.e(TAG,"Removing spaces "+picturePath);
                            picturePath.replace(" ","-");
                        }
                        Log.e(TAG,"Pciture after "+picturePath);
                        cursor.close();
